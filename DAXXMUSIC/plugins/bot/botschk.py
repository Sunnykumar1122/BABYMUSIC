...
BOT_LIST = ["Babee_music_bot", "Babee_chat_bot", "ROLEX_SPAM_BOT01", "ROLEX_USER_BOT", "Baby_banall_bot", "Zeninxbot",]

@app.on_message(filters.command("botschk") & filters.user(OWNER_ID))
async def bots_chk(_, message):
    msg = await message.reply_photo(photo="https://telegra.ph//file/a9e8e650ac5b49d504902.jpg", caption="**ᴄʜᴇᴄᴋɪɴɢ ʙᴏᴛs sᴛᴀᴛs ᴀʟɪᴠᴇ ᴏʀ ᴅᴇᴀᴅ...**")
